...
Stream<String?> startSerial() {
    return SerialportPlatform.instance.startSerial();
  }
  ...
  Future<String?> openPort(
    ...
    return SerialportPlatform.instance.openPort(
  ...
  Future<List<String>?> getAvailablePorts() {
    return SerialportPlatform.instance.getAvailablePorts();
  }
  ...
  Future<String?> closePort() {
    return SerialportPlatform.instance.closePort();
  }
